...
[Unit]
Description=agents_invest daily AI WIN rebuild and Telegram summary
...
ExecStart=$PYTHON $APP_DIR/scripts/rebuild_daily_ai_win_dashboard.py --portfolio-start 2026-06-01 --top-n 5 --universe-size 180
