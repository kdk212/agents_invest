...
put_string "max-same-sector" "3"
put_string "max-sector-weight-pct" "30.0"
put_string "min-buy-score" "7.0"
put_string "min-profit-score" "60.0"
put_string "min-risk-reward" "1.2"
put_string "max-expected-loss-pct" "7.0"
